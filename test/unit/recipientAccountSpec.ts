import { Configuration, RecipientAccount } from "../../lib";
...
//     sinon
//       .stub(RecipientAccount, "find")
//       .withArgs("R-91XPJZTR612MG", "A-A1B2C3D4E5F6")
//       .callsFake(() => {
...
//       });
//     const data = await RecipientAccount.find(
//       "R-91XPJZTR612MG",
//       "A-A1B2C3D4E5F6",
//     );
...
//     Configuration.setApiSecret("secret-code");
//     sinon
//       .stub(RecipientAccount, "create")
//       .withArgs("R-91XPMEHZ44RMP", body)
//       .callsFake(() => {
...
//     Configuration.setApiSecret("secret-code");
//     sinon
//       .stub(RecipientAccount, "update")
//       .withArgs("R-91XPMEHZ44RMP", "A-A1B2C3D4E5F6", body)
//       .callsFake(() => {
//         return "{'ok':true,'object':'updated'}";
//       });
//     const data = await RecipientAccount.update(
//       "R-91XPMEHZ44RMP",
//       "A-A1B2C3D4E5F6",
//       body,
//     );
...
//     sinon
//       .stub(RecipientAccount, "update")
//       .withArgs("R-123", "A-A1B2C3D4E5F6", body)
//       .callsFake(() => {
//         return "{'ok':false,'errors':[{'code':'not_found','message':'Object not found'}]}";
//       });
