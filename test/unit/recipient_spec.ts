...
describe("Retrieve recipient", () => {
    it("ok field should be true", async () => {
        ...
        sinon.stub(Recipient, "find").withArgs("R-PuzPJLVYQXBbPSMQKwmJ5G").callsFake(() => {
...
describe("Retrieve recipient invalid Recipient Id", () => {
    it("ok field should be false", async () => {
        ...
        Configuration.setApiKey("access-code");
        Configuration.setApiSecret("secret-code");
        sinon.stub(Recipient, "find").withArgs("R-123").callsFake(() => {
...
describe("Update recipient", () => {
    it("ok field should be true", async () => {
        ...
        sinon.stub(Recipient, "update").withArgs("R-9191XPM8233T710", body).callsFake(() => {
...
describe("Update recipient Invalid Recipient Id", () => {
    it("ok field should be false", async () => {
        ...
        sinon.stub(Recipient, "update").withArgs("R-123", body).callsFake(() => {
            return ("{'ok':false,'errors':[{'code':'not_found','message':'Object not found'}]}");
        });
...
describe("List all recipients", () => {
    it("ok field should be true", async () => {
        Configuration.setApiKey("access-code");
        Configuration.setApiSecret("secret-code");
        sinon.stub(Recipient, "search").withArgs().callsFake(() => {
...
describe("Retrieve logs", () => {
    it("ok field should be true", async () => {
        Configuration.setApiKey("access-code");
        Configuration.setApiSecret("secret-code");
        sinon.stub(Recipient, "find").withArgs("R-91XPJZTR612MG", "logs?pageSize=10").callsFake(() => {
            return ("{'ok':true,'activities'");
        });

        const data: string = await Recipient.find("R-91XPJZTR612MG", "logs?pageSize=10");
        assert.equal(data.substring(6, 10), "true");
...
describe("Retrieve logs invalid recipient id", () => {
    it("ok field should be false", async () => {
        Configuration.setApiKey("access-code");
        Configuration.setApiSecret("secret-code");
        sinon.stub(Recipient, "find").withArgs("R-123", "logs?pageSize=10").callsFake(() => {
...
describe("Retrieve payments", () => {
    it("ok field should be true", async () => {
        Configuration.setApiKey("access-code");
        Configuration.setApiSecret("secret-code");
        sinon.stub(Recipient, "find").withArgs("R-91XPJZTR612MG", "payments").callsFake(() => {
...
describe("Retrieve payments invalid recipient id", () => {
    it("ok field should be false", async () => {
        Configuration.setApiKey("access-code");
        Configuration.setApiSecret("secret-code");
        sinon.stub(Recipient, "find").withArgs("R-123", "payments").callsFake(() => {
            return ("{'ok':false,'errors':[{'code':'not_found','message':'Object not found'}]}");
        });
