[paymentrails](../README.md) > ["types"](../modules/_types_.md) > [WhiteLabel](../modules/_types_.whitelabel.md) > [SettingsAttributes](../interfaces/_types_.whitelabel.settingsattributes.md)
